...
# num_customers = 10
# num_customers = 200
argParser.add_argument('--res_file', type=str, default='tsp_{}.json'.format(num_customers))
argParser.add_argument('--res_train_file', type=str, default='tsp_{}_train.json'.format(num_customers))
argParser.add_argument('--res_val_file', type=str, default='tsp_{}_val.json'.format(num_customers))
argParser.add_argument('--res_test_file', type=str, default='tsp_{}_test.json'.format(num_customers))
...
argParser.add_argument('--num_customers', type=int, default=num_customers)
...
def main():
	...
	path = './data/tsp_{}/'.format(num_customers)
